...
<center>
 <%
	...
	try {
		...
		String sqlCount = "SELECT COUNT(*) FROM carwash";
		...
		String sqlList = "SELECT BUSINESSNAME, CITYNAME, MINICIPAL, INDUSTRY, WASHTYPE, ADDRESS, TELEPHONE from carwash where STEP2 >=" +start + " and STEP2 <= " + end + " order by step2 asc";
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr align="center">
		...
		<td width="100">업종</td>
		<td width="70">세차유형</td>
		<td width="320">소재지 주소</td>
		<td width="50">전화 번호</td>
		<td width="7"></td>
  </tr>
<%
	if(total==0) {
